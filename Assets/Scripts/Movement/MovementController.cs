...
namespace Ametrin.KunstBLL.Movement{
    ...
    public sealed class MovementController : MonoBehaviour{
        ...
        private void Move(){
            ...
            var currentHorizontalSpeed = new Vector3(RigidBody.velocity.x, 0f, RigidBody.velocity.z).magnitude;
            ...
            RigidBody.AddForce(inputDirection * (currentSpeed * Time.deltaTime) + velocity * Time.deltaTime);
